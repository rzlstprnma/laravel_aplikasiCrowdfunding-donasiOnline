    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted mt-4 mb-4">ANDA TIDAK MEMILIKI HAK UNTUK MENGAKSES HALAMAN INI !</p>
                <a href="/" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Kembali Ke Home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
